...
Mobile.tap(findTestObject('Object Repository/FailedRegister/android.widget.TextView - No account yet Create one'), 0)

Mobile.tap(findTestObject('Object Repository/FailedRegister/android.widget.Button - REGISTER'), 0)
